/* src/components/ui/layouts/DynamicBackgroundLayouts.tsx */
...
const DynamicLayout: React.FC<LayoutComponentProps> = ({ children }) => {
	const [backgroundImage, setBackgroundImage] = useState(
		"./assets/img/vibrant/background-01-2560x1770.jpeg",
	);
	...
	return (
		...
		>
			...
			<Footer className={styles.footer}>NextVision@2024 v2.8.600</Footer>
		</Layout>
	);
};
